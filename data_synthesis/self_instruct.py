...
class SelfInstructor:
    ...
    async def run(self):
        ...
        from instructors.agent import generate as agent_generator
        from instructors.awareness import generate as awareness_generator
        from instructors.card import generate as card_generator
        ...
        from instructors.cot import generate as cot_generator
        from instructors.counterfactual_contextual import (
            generate as counterfactual_contextual_generator,
        )
        from instructors.detailed_writing import (
            generate as detailed_writing_generator,
        )
        from instructors.editor import generate as editor_generator
        from instructors.experience import generate as experience_generator
        from instructors.general import generate as general_generator
        from instructors.gtkm import generate as gtkm_generator
        from instructors.joke import generate as joke_generator
        from instructors.misconception import (
            generate as misconception_generator,
        )
        from instructors.multiple_choice import (
            generate as multiple_choice_generator,
        )
        from instructors.orca import generate as orca_generator
        from instructors.plan import generate as plan_generator
        from instructors.riddle import generate as riddle_generator
        from instructors.roleplay import generate as roleplay_generator
        from instructors.rp import generate as rp_generator
        from instructors.rp import generate_cards
        from instructors.song import generate as song_generator
        from instructors.stylized_response import (
            generate as stylized_response_generator,
        )
        from instructors.trivia import generate as trivia_generator
        from instructors.wordgame import generate as wordgame_generator
        from instructors.writing import generate as writing_generator
        from instructors.agieval import generate as agieval_generator
        from instructors.bbh_hard import generate as bbh_hard_generator
